   ...
   <form id="principal" runat="server" class="form-horizontal">
     ...
     <div class="form-group">
       <div class="col-lg-12">
         <div class="input-group">
          ...
          <span class="input-group-btn">
            <asp:Button UseSubmitBehavior="false" runat="server" id="btnPesquisar" Text="Pesquisar" CssClass="btn btn-default" OnClick="btnPesquisarCidade" />
          </span>
         </div>
       </div>
     </div>
      ...
      <asp:GridView runat="server"  AutoGenerateColumns="false" id="gridListaCidade" CssClass="table table-bordered table-hover">
         ...
         <Columns>
             <asp:BoundField DataField="idCidade" HeaderText="Id_CIDADE"/>
